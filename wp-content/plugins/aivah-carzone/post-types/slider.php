<?php
	 ...
	 */
	if ( !function_exists( 'iva_at_cpt_slider' ) ) {
		function iva_at_cpt_slider() {
			$labels = array(
		...
		add_action('init', 'iva_at_cpt_slider');
	}
	//
	if ( !function_exists( 'iva_at_taxoniomy_slider' ) ) {
		function iva_at_taxoniomy_slider() {
		...
		add_action('init', 'iva_at_taxoniomy_slider');
	}
	//
	if ( !function_exists( 'iva_at_cpt_slider_columns' ) ) {	
		function iva_at_cpt_slider_columns($columns) {
				$columns = array(
		...
		add_filter('manage_edit-slider_columns', 'iva_at_cpt_slider_columns');
	}
	//
	if ( !function_exists( 'iva_at_cpt_manage_slider_columns' ) ) {		
		function iva_at_cpt_manage_slider_columns($name) {
		...
		add_action('manage_posts_custom_column', 'iva_at_cpt_manage_slider_columns', 10, 2);
	}
?>