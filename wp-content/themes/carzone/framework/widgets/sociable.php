	...
	class sociable_widget extends WP_Widget {
		...
		function __construct() {
			...
			$widget_ops = array( 
				...
				'description'	=> __('Sociable widget for sidebar.', 'iva_theme_admin')
			);
			...
			/* Create the widget. */
			parent::__construct( 'sociable_widget',THEMENAME.' - Sociables', $widget_ops, $control_ops );
		}
		...
		function form( $instance ) {
			...
			<p>
				...
				<label for="<?php echo $this->get_field_id( 'Color' ); ?>"><?php _e('Color:', 'iva_theme_admin'); ?></label>
