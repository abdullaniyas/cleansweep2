 ...
 */
	...
	class flickr_widgets extends WP_Widget {
		...
		function __construct() {
			...
			$widget_ops = array(
				'classname'		=> 'flickr-wg',
				'description'	=> __('Use this widget to display your flickr gallery.', 'iva_theme_admin')
			);
			...
			/* Create the widget. */
			parent::__construct( 'flickr_widget',THEMENAME.' - Flickr Photos', $widget_ops, $control_ops );
		}
		...
		function form( $instance ) {
			...
			?>
			<p>
				<label for="<?php echo $this->get_field_id( 'flickr_title' ); ?>"><?php _e('Title:', 'iva_theme_admin'); ?></label>
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'flickr_id' ); ?>"><?php _e("Flickr ID: <small>Find your ID from <a href='http://idgettr.com' target='_blank'>idGettr</a></small>", 'iva_theme_admin'); ?></label>
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'flickr_limits' ); ?>"><?php _e('How many photos you would like to display?:', 'iva_theme_admin'); ?></label>
