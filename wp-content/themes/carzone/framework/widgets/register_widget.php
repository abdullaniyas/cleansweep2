<?php
	...
	if(function_exists('register_sidebar')){
		...
		register_sidebar(array(
			'name'			=> 'Header Style 3 - Right',
			'id'			=> 'heaer_right_area',
			'description'	=> __('Select only one widget which will appear on your header right side area in Header Style3', 'iva_theme_admin'),
			'before_widget'	=> '<div id="%1$s" class="header-s3-right %2$s">',
			'after_widget'	=> '</div>',
			'before_title'	=> '<strong>',
			'after_title'	=> '</strong>',
		));
	...
	if(function_exists('register_sidebar')){
		...
		register_sidebar(array(
			'name'			=> 'Copyright Left Content',
			'id'			=> 'footer_leftcopyright',
			'description'	=> __('Select only one widget which will appear on your Copyright Left Content', 'iva_theme_admin'),
			'before_widget'	=> '<aside id="%1$s" class="%2$s">',
			'after_widget'	=> '</aside>',
			'before_title'	=> '<h3 class="widget-title">',
			'after_title'	=> '</h3>',
		...
		register_sidebar(array(
			'name'			=> 'Copyright Right Content',
			'id'			=> 'footer_rightcopyright',
			'description'	=> __('Select only one widget which will appear on your Copyright Right contemt', 'iva_theme_admin'),
			'before_widget'	=> '<aside id="%1$s" class="%2$s">',
			'after_widget'	=> '</aside>',
			'before_title'	=> '<h3 class="widget-title">',
			'after_title'	=> '</h3>',
		...
		register_sidebar(array(
			'name'			=> 'Sticky Content',
			'id'			=> 'iva_stickycontent',
			'description'	=> __('Select only one widget which will appear on your sticky bar Content', 'iva_theme_admin'),
			'before_widget'	=> '<aside id="%1$s" class="%2$s">',
			'after_widget'	=> '</aside>',
			'before_title'	=> '<h3 class="widget-title">',
			'after_title'	=> '</h3>',
