...
function atp_style() {
	$atp_option_var = array(
		...
		'atp_sidebar_link','atp_sidebar_link_hover','atp_countdown_font','iva_locationbg', 'iva_location_textcolor', 'atp_header_logo_bgcolor'
	);
...
.header_section { <?php echo $subheaderBG; echo $subheader_PT; echo $subheader_PB;?> }
...
.header_section .page-title { <?php echo $subheaderText; ?> }
