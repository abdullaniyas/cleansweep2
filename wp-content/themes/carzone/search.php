	...
	<div id="primary" class="pagemid">
		<div class="inner">			
			...
			<div class="content-area">
				...
				<div class="iva-search-restult"><?php _e( 'Apologies, but no results were found for the requested archive. Perhaps searching will help find a related post.', 'iva_theme_front' ); ?></div>
