...
if( !function_exists('iva_enqueue_scripts')){
	function iva_enqueue_scripts() {
		...
		//Directory URI
        $data["directory_uri"] = get_template_directory_uri();
...
if (!class_exists('ATP_Theme')) {
    ...
    class ATP_Theme
    {
		 ...
		 */
        function atp_head(){
            require_once(FRAMEWORK_DIR . 'common/admin_scripts.php');
        }
...
/**
 * Defines Template directory URI path for towing directory
 */
define( 'AUTOTOW_URI', get_template_directory_uri() . '/towing/');

/**
 * Defines Template directory path for towing directory
 */
define( 'AUTOTOW_DIR', get_template_directory() . '/towing/');
if( !defined('AUTOTOWING_DIR') ) {
    define( 'AUTOTOWING_DIR', get_template_directory() . '/towing/');
}
if( defined('AUTOTOWING_DIR') ) {
    require_once( AUTOTOWING_DIR . 'index.php' );
